...
mod tests {
    ...
    use crate::types::{
        DumpsysPriority, InputSource, InstallLocationOption, InstallOptions, KeyCode, KeyEventType, LogcatLevel, LogcatOptions, LogcatTag, MotionEvent, PackageFlags, ScreenRecordOptions, SELinuxType,
    ...
    fn test_signals() {
        ...
        let child_thread = thread::Builder::new().name("cmd_wait".to_string()).spawn(move || {
